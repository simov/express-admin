...
exports.andColumns = function (table, fk, ref, pk) {
...
exports.joins = function (table, fk, ref, pk, alias) {
    var result = [
        ' LEFT JOIN', this.table(ref), (alias&&this.justName(alias.alias)), 'ON',
        this.andColumns(table, fk, (alias||ref), pk)
    ].join(' ');
    return result;
}

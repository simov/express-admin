...
MySql.prototype.connect = function (options, cb) {
...
PostgreSQL.prototype.connect = function (options, cb) {
...
PostgreSQL.prototype.query = function (sql, cb) {
...
SQLite.prototype.connect = function (options, cb) {
    this.connection = new this.client.Database(options.database);
    this.config = {schema:''};
    cb();
}

SQLite.prototype.query = function (sql, cb) {

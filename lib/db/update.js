    ...
    query: function (args, settings, record) {
        if (record.insert) {
            ...
            var pk = settings.table.pk;
                str = query.replace('delete', sql.table(settings.table), sql.andValues(settings.table, pk, record.pk));
            ...
            var pk = settings.table.pk,
                ...
                str = query.replace('update',
                    sql.table(settings.table), data.pairs.join(), sql.andValues(settings.table, pk, record.pk));
